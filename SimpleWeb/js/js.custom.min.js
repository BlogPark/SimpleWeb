$(function () {
    ...
    $('.countdown').each(function () {
        ...
        $(this).downCount({
            ...
            var ad = adul.parent().next().next().next().find(".tousu");
            ad.show();
            //alert('倒计时结束!');
        });
    });
...
function providehelp() {
    ...
    $.ajax({
        url: "/CustomOperate/addhelporder",
        datatype: "json",
        async: false,
        type: "POST",
...
function activemember() {
    ...
    $.ajax({
        url: '/CustomOperate/activemember',
        dataType: 'Json',
...
function updatehelporder(id, aid) {
    $.ajax({
        url: '/CustomOperate/paymoneysplit',
        dataType: 'Json',
        data: { 'id': id, 'aid': aid },
        type: 'POST',
        success: function (data) {
...
function updatesingleorder(aid, hid) {
    $.ajax({
        url: '/CustomOperate/singlefinishorder',
        dataType: 'Json',
...
function autofill() {
    $.ajax({
        url: '/CustomOperate/GetPromptCode',
        dataType: 'Json',
        type: 'POST',
        success: function (data) {
            if (data == '0') {
...
function submithelpereporting() {
    ...
    $.ajax({
        url: '/CustomOperate/AddhelpReporting',
        dataType: 'Json',
        type: 'POST',
...
function submitacceptreporting() {
    ...
    var reportingtext = $("#reportingtext").val();
    $.ajax({
        url: '/CustomOperate/AddacceptReporting',
        dataType: 'Json',
        type: 'POST',
        data: { "orderid": model_orderid, "reason": reasontype, "title": title, "text": reportingtext },
        success: function (data) {
...
function showcontentus(id) {
    var title = $("#id" + id + "title").html();
    var msgcontent = $("#id" + id + "msgcontent").val();
    var recontent = $("#id" + id + "recontent").val();
    $("#myModalLabel").html(title);
    $("#msgcontent").html(msgcontent);
    $("#recontent").html(recontent);
}
